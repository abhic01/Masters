...
NON_PGA_TOUR = {
    # Players currently outside the PGA Tour rotation for this season.
    # This intentionally excludes Brooks Koepka and Patrick Reed, who have left LIV
    # and are working their way back toward the PGA Tour.
    "bryson-dechambeau",
    "sergio-garcia",
    "tyrrell-hatton",
    "dustin-johnson",
...
def player_meta_from_name(name: str) -> Dict[str, Any]:
    ...
    return {
        ...
        "oddsRank": AUTO_DRAFT_RANK.get(athlete_id, 999),
    }
...
DRAFT_POOL = sorted(load_players(), key=player_priority_score)
